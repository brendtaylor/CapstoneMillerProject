...
router.get("/work-orders/archived-summary", authorize(['Admin']), getArchivedWorkOrderSummary);
...
router.get("/work-orders/:wo_id/archived-tickets", authorize(['Admin']), getArchivedTicketsByWorkOrder);
